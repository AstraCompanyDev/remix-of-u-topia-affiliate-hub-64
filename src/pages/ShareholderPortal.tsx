        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="overflow-hidden">
            <CardContent className="p-6">
              ...
              <p className="text-2xl md:text-3xl font-bold text-foreground mb-1">$12,450</p>
          ...
          <Card className="overflow-hidden">
            <CardContent className="p-6">
              ...
              <p className="text-2xl md:text-3xl font-bold text-foreground mb-1">$2,180</p>
              <p className="text-sm text-muted-foreground">Pending</p>
              <p className="text-xs text-muted-foreground/70 mt-2">Awaiting clearance</p>
            </CardContent>
          </Card>
          ...
          <Card className="overflow-hidden">
            <CardContent className="p-6">
              ...
              <p className="text-2xl md:text-3xl font-bold text-foreground mb-1">5,240</p>
              <p className="text-sm text-muted-foreground">$U Tokens</p>
              <div className="flex items-center gap-1 mt-2 text-xs text-green-500">
                <ArrowUpRight className="h-3 w-3" />
                +15% value
              </div>
          ...
          <Card className="overflow-hidden">
            <CardContent className="p-6">
              ...
              <p className="text-2xl md:text-3xl font-bold text-foreground mb-1">85</p>
              <p className="text-sm text-muted-foreground">My Network</p>
              <p className="text-xs text-muted-foreground/70 mt-2">Total Connections</p>
            </CardContent>
          </Card>
        </div>
      </section>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Button
                  ...
                  className="w-full mt-4"
                  onClick={() => {
                    toast({ title: "Calendar Coming Soon", description: "Full event calendar will be available soon!" });
                  }}
                >
