...
export function ReferralToolsCard() {
  ...
  const handleShare = (platform: string) => {
    ...
    const message = encodeURIComponent('Join U-topia using my referral link: ' + fullReferralUrl);
    let url = '';
  ...
  return (
    <div className="feature-card p-8 md:p-10">
      ...
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-foreground">Your Referral Tools</h3>
